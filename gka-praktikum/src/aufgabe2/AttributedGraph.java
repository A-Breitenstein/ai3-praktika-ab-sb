...
public class AttributedGraph implements Graph {
    ...
    private AttributedGraph(Graph graph, Map<String, Integer> attributeMap) {
        this.graph = graph;
        this.attributeMap = attributeMap;
    }

    public static AttributedGraph create(Graph grap, Map<String, Integer> attributeMap) {
        return new AttributedGraph(grap, attributeMap);
    }
    //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ METHODS @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
